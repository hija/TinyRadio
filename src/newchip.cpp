...
#include <Arduino.h>
#include <TinyWireM.h>     // The chip is controlled via the standard Arduiino TinyWireM.library and the IIC/I2C bus.

#include <RADIO.h>    // Include the common radio library interface
#include <newchip.h>

// ----- Definitions for the TinyWireM.communication
...
// write a register value using 2 bytes into the TinyWireM.
